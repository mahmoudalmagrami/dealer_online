<?php $__env->startSection('title','Dashboard E-commerce'); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/dashboard-ecommerce.css')); ?>">
<?php $__env->stopSection(); ?>
        ...
        <div class="card-body pt-0">
          <div class="d-flex justify-content-between align-items-end">
            ...
            <div class="dashboard-content-right">
              <img src="<?php echo e(asset('images/icon/cup.png')); ?>" height="220" width="220" class="img-fluid"
                ...
                <tbody>
                    ...
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-10.jpg')); ?>" alt="avatar"
                  ...
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                  ...
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-12.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                ...
                <tbody>
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                ...
                <tbody>
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-25.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                  ...
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-15.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                          <h6 class="media-heading mb-0">Pauly Dez</h6>
                ...
                <tbody>
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-16.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                  ...
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                          <h6 class="media-heading mb-0">Pauly Dez</h6>
                  ...
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
                ...
                <tbody>
                  <tr>
                    <td class="pr-75">
                      <div class="media align-items-center">
                        <a class="media-left mr-50" href="javascript:;">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-19.jpg')); ?>" alt="avatar"
                            class="rounded-circle" height="30" width="30">
                        </a>
                        <div class="media-body">
            ...
            <tbody>
              <tr>
                <td class="py-1 line-ellipsis">
                  <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/fs.png')); ?>" alt="card" height="24"
              ...
              <tr>
                <td class="py-1 line-ellipsis">
                  <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/puma.png')); ?>" alt="card" height="24"
                    width="24">Puma Shoes
                </td>
                <td class="py-1">
              ...
              <tr>
                <td class="py-1 line-ellipsis">
                  <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/nike.png')); ?>" alt="card" height="24"
              ...
              <tr>
                <td class="py-1 line-ellipsis">
                  <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/one-plus.png')); ?>" alt="card" height="24"
              ...
              <tr>
                <td class="py-1 line-ellipsis">
                  <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/google.png')); ?>" alt="card" height="24"
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelProjects\smart-trader\resources\views/pages/dashboard-ecommerce.blade.php ENDPATH**/ ?>